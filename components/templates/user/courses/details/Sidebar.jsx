                ...
                items.map(
                  (lesson, index) =>
                    lesson.type == "video" && (
                      ...
                      >
                        <div className="group flex w-full justify-between py-2 transition-colors hover:text-green-400">
                          <div className="flex w-3/4 items-center gap-x-1.5">
                            ...
                            <p className="w-2/3 cursor-pointer overflow-hidden pr-0.5 text-right text-sm font-semibold text-ellipsis whitespace-nowrap text-gray-600 transition-colors group-hover:text-green-400 hover:text-green-400 md:text-base">
                              {lesson.title}
                            </p>
                          </div>

                          <div className="transition-colors group-hover:text-green-400">
